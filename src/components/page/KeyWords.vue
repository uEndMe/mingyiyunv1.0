    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-paperclip"></i> 关键词管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            @selection-change="handleChangeSelect">
                ...
                <el-table-column prop="is_hot" label="是否热门" align="center">
                    <template slot-scope="scope">
                        ...
                        @change="changeHot(scope.row)"></el-switch>
                    </template>
                </el-table-column>
        ...
        'create_edit_params.sort' () {
            ...
            for(let item of str){
                if(!Number(item) && item !== '0'){
                    if(item === '-' && str.lastIndexOf(item) === 0) continue
                    this.create_edit_params.sort = str.slice(0,str.length - 1);
                }
            }
        }
    },
