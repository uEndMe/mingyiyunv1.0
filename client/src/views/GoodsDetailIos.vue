<template>
    <div class="bg-gray">
        ...
        <div class="goods-btn the-wall">
            <div class="goods-apply the-white">
                <div>
                    <div>
                        <div @click="$router.push('/cs')">
...
import { Swipe, SwipeItem, Image as VanImage, Icon, Button, Popup, Dialog } from 'vant';
import { collectionGoods, collectionDel } from '../api/request';
export default {
    components: {
        myTitle,
    ...
    methods: {
        ...
        applyBtnClick () {
            this.randomStr = this.randomStr || this.randomString(8);
            Dialog.alert({
                title: 'SuccessFully received',
                message: `Your discount code is <span style="color: #1989fa;">${this.randomStr}</span> please input it when purchasing`,
        ...
        randomString (len) {
            ...
            let str = '';
            for (let i = 0; i < len; i++) {
                str += $chars.charAt(Math.floor(Math.random() * pos));
            }
            return str;
        },
